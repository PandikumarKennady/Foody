...
let UsersService = class UsersService {
    ...
    async findRestaurantAdmins() {
        return this.userModel
            .find({ role: user_schema_1.UserRole.RESTAURANT_ADMIN })
            .select('-password')
            .exec();
    }
    async findByRestaurantUid(restaurantUid) {
        return this.userModel
            .findOne({ restaurantUid, role: user_schema_1.UserRole.RESTAURANT_ADMIN })
            .exec();
    }
